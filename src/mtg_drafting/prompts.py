...
_SYSTEM_PROMPT = (
    ...
    "Take the raw strongest card in the pack regardless of color - the FUNDAMENTAL "
    "VALUE EQUATIONS section below defines what 'strongest' means in principle. "
    ...
    "- Generates card advantage. Trades one card for multiple. This can mean a "
    "removal spell that hits multiple cards, a draw spell that draws more than one "
    "card, or a discard spell that takes away more than one of your opponent's "
    "cards.\n"
    "- Mana efficiency. Creatures with stats or abilities above curve, forcing the "
    "opponent to spend more than you paid to deal with it. Likewise, cheap spells "
    "that allow you to answer expensive threats for less than the opponent paid. "
    "In both cases, the cards trade up.\n"
